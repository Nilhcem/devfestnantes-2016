package com.nilhcem.devfestnantes.data.database.dao;
...
import com.nilhcem.devfestnantes.data.database.DbMapper;
import com.nilhcem.devfestnantes.data.database.model.SelectedSession;
import com.nilhcem.devfestnantes.data.database.model.Session;
...
public class SessionsDao {
    ...
    public Observable<List<com.nilhcem.devfestnantes.data.app.model.Session>> getSessions() {
        return getSessions("SELECT * FROM " + Session.TABLE);
    }

    public Observable<com.nilhcem.devfestnantes.data.app.model.Session> getSessionById(int id) {
        return getSessions("SELECT * FROM " + Session.TABLE + " WHERE " + Session.ID + "=?", Integer.toString(id)).flatMap(Observable::from).first();
    }

    public Observable<List<com.nilhcem.devfestnantes.data.app.model.Session>> getSelectedSessions() {
    ...
    public Observable<List<com.nilhcem.devfestnantes.data.app.model.Session>> getSelectedSessions(LocalDateTime slotTime) {
    ...
    public void toggleSelectedSessionState(com.nilhcem.devfestnantes.data.app.model.Session session, boolean insert) {
    ...
    public void saveSessions(List<com.nilhcem.devfestnantes.data.app.model.Session> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Session.TABLE, null);
            for (com.nilhcem.devfestnantes.data.app.model.Session session : toSave) {
    ...
    public Observable<Boolean> isSelected(com.nilhcem.devfestnantes.data.app.model.Session session) {
    ...
    private Observable<List<com.nilhcem.devfestnantes.data.app.model.Session>> getSessions(String query, String... args) {
