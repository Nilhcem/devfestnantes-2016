...
public class DbMapper {
    ...
    public Session fromAppSession(@Nullable com.nilhcem.devfestnantes.data.app.model.Session from) {
        if (from == null) {
            return null;
        }
    ...
    public Speaker fromAppSpeaker(@Nullable com.nilhcem.devfestnantes.data.app.model.Speaker from) {
        if (from == null) {
            return null;
        }
